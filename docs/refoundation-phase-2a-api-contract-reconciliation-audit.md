...
Evidence:
- `docs/operation-grammar.md`
- `docs/api-source-of-truth.md`
- `docs/api-plane-surface-model.md`
...
- High-level projections in `registry/api-operation-projections.v1.json` reference operations that are still planned (expected), but should be clearly marked as non-execution compositions in docs/conformance notes.
