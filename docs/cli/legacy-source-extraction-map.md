...
| `source/assets/shell` | shell UX | legacy shell prompt/render/session assets | yes | cli/docs/remove | salvage only assets that still serve canonical shell UX; delete session-bound legacy pieces | V21.x |
