...
| `source/cmd/session` | `session status`, `session summary`, `session attach`, substrate entry bootstrap, shell landing render hooks | `legacy_session_surface` | `api` + `docs/remove` + `cli` | V43, V51, V53, V54, V55 | partial |
