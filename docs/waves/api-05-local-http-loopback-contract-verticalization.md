...
| `api` | `docs/local-http-loopback-contract.md` | added | summarize the API.05 contract |
| `api` | `docs/waves/api-05-local-http-loopback-contract-verticalization.md` | added | record scope and validation |
