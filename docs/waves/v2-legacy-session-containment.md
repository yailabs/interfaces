...
| ---- | ---- | ----------- | ------ |
| api | `docs/compat/session-legacy-containment.md` | create | central containment policy |
| api | `docs/waves/v2-legacy-session-containment.md` | create | delivery report |
...
| loom | `docs/sdk-first-client-contract.md` | docs text only | classify session posture as non-canonical UX language |
...
The canonical warning is now present in docs/help:
...
| api | `test -f docs/compat/session-legacy-containment.md` | pass | new policy |
| api | `test -f docs/waves/v2-legacy-session-containment.md` | pass | report |
...
| loom | `cargo test` | fail | compile fails on existing missing `T: Clone` bound in `src/yai/runtime.rs`; unrelated to V2 docs/copy changes |
...
* [x] `docs/compat/session-legacy-containment.md` exists
* [x] `docs/waves/v2-legacy-session-containment.md` exists
* [x] changed docs/help text marks session as legacy compatibility
* [x] changed docs/help text says session is not canonical
* [x] changed docs/help text points toward auth/case/shell/client
...
* [x] no Loom behavior changed except docs/copy if touched
