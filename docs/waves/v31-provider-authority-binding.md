...
| ---- | --------- | ----------- | ------ |
| api | `docs/execution/provider-authority-binding.md` | create | provider authority binding |
| api | `docs/waves/v31-provider-authority-binding.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f docs/execution/provider-authority-binding.md` | pass | new policy doc |
| api | `test -f docs/waves/v31-provider-authority-binding.md` | pass | new report |
...
* [x] `docs/execution/provider-authority-binding.md` exists
* [x] `docs/waves/v31-provider-authority-binding.md` exists
