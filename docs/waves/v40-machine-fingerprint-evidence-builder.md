...
| ---- | --------- | ----------- | ------ |
| api | `docs/execution/machine-fingerprint-evidence-builder.md` | create | machine evidence boundary |
| api | `docs/waves/v40-machine-fingerprint-evidence-builder.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f docs/execution/machine-fingerprint-evidence-builder.md` | pass | new policy doc |
| api | `test -f docs/waves/v40-machine-fingerprint-evidence-builder.md` | pass | new report |
...
* [x] `docs/execution/machine-fingerprint-evidence-builder.md` exists
* [x] `docs/waves/v40-machine-fingerprint-evidence-builder.md` exists
