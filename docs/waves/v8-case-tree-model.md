...
| ---- | ---- | ----------- | ------ |
| api | `docs/case/case-tree-model.md` | create | canonical case tree model |
| api | `docs/waves/v8-case-tree-model.md` | create | delivery report |
...
| api | `test -f docs/case/case-tree-model.md` | pass | new tree doc |
| api | `test -f docs/waves/v8-case-tree-model.md` | pass | new report |
...
* [x] `docs/case/case-tree-model.md` exists
* [x] `docs/waves/v8-case-tree-model.md` exists
