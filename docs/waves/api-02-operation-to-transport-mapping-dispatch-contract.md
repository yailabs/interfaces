...
| `api` | `docs/operation-to-transport-mapping.md` | added | document the API.02 mapping model and dispatch interpretation |
...
| `api` | `docs/waves/api-02-operation-to-transport-mapping-dispatch-contract.md` | added | record delivery scope, audit, validation, and outcome |
...
| `api` | `test -f docs/operation-to-transport-mapping.md` | pass | required existence check |
| `api` | `test -f docs/waves/api-02-operation-to-transport-mapping-dispatch-contract.md` | pass | required existence check |
