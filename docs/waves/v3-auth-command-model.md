...
| ---- | ---- | ----------- | ------ |
| api | `docs/waves/v3-auth-command-model.md` | create | delivery report |
...
| api | `test -f docs/waves/v3-auth-command-model.md` | pass | new report |
...
Result: matches in V2/V3 docs/help and changed CLI/SDK/Loom docs.
...
* [x] `docs/waves/v3-auth-command-model.md` exists
