...
| ---- | ---- | ----------- | ------ |
| api | `docs/runtime/runtime-readiness-projection.md` | create | readiness projection model |
| api | `docs/waves/v15-runtime-readiness-projection.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f docs/runtime/runtime-readiness-projection.md` | pass | new runtime doc |
| api | `test -f docs/waves/v15-runtime-readiness-projection.md` | pass | new report |
...
* [x] `docs/runtime/runtime-readiness-projection.md` exists
* [x] `docs/waves/v15-runtime-readiness-projection.md` exists
