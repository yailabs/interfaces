...
| ---- | --------- | ----------- | ------ |
| api | `docs/cli/residual-domain-source-deletion-pass.md` | create | residual deletion record |
| api | `docs/waves/v21-7-residual-domain-source-deletion-pass.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f docs/cli/residual-domain-source-deletion-pass.md` | pass | new doc |
| api | `test -f docs/waves/v21-7-residual-domain-source-deletion-pass.md` | pass | new report |
...
* [x] `docs/cli/residual-domain-source-deletion-pass.md` exists
* [x] `docs/waves/v21-7-residual-domain-source-deletion-pass.md` exists
