...
| ---- | ---- | ----------- | ------ |
| api | `docs/case/root-user-case.md` | create | root user case model |
| api | `docs/waves/v6-root-user-case.md` | create | delivery report |
...
| api | `test -f docs/case/root-user-case.md` | pass | new case doc |
| api | `test -f docs/waves/v6-root-user-case.md` | pass | new report |
...
rg -n "case://user|root operational case|root harness|Root User Case|session|active case|operator context" docs/case docs/waves
```
...
* [x] `docs/case/root-user-case.md` exists
* [x] `docs/waves/v6-root-user-case.md` exists
