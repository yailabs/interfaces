...
* useful semantics extracted to docs/spec artifacts;
...
| ---- | ---- | ----------- | ------ |
| api | `docs/cli/legacy-runtime-core-extraction.md` | create | extracted runtime/core semantics |
| api | `docs/waves/v21-3-runtime-core-logic-extraction.md` | create | delivery report |
...
| ----------- | ------------ | ------------------ | ------------------ |
| `source/main.c` | `yai/core` + `api` | `docs/cli/legacy-runtime-core-extraction.md`, `Documentation/legacy-cli-runtime-core-extraction.md` | blocked |
| `source/shared` | `cli` | `docs/cli/legacy-runtime-core-extraction.md` | partial |
| `source/out` | `cli` | `docs/cli/legacy-runtime-core-extraction.md` | partial |
| `source/cmd/runtime` | `yai/core` + `api` | `docs/cli/legacy-runtime-core-extraction.md` | partial |
| `source/cmd/provider` | `api` + `sdk` + `yai/core` | `docs/cli/legacy-runtime-core-extraction.md` | partial |
| `source/cmd/agent` | `yai/core` + `api` + `sdk` | `docs/cli/legacy-runtime-core-extraction.md` | partial |
| `source/cmd/flow` | `yai/core` + `api` | `docs/cli/legacy-runtime-core-extraction.md`, `Documentation/legacy-cli-runtime-core-extraction.md` | blocked |
| `source/cmd/govern` | `yai/core` + `api` | `docs/cli/legacy-runtime-core-extraction.md` | partial |
| `source/cmd/knowledge` | `yai/core` + `api` | `docs/cli/legacy-runtime-core-extraction.md`, `Documentation/legacy-cli-runtime-core-extraction.md` | blocked |
| `source/cmd/analytics` | `api` + `sdk` + `yai/core` | `docs/cli/legacy-runtime-core-extraction.md` | partial |
| `source/cmd/logs` | `yai/core` + `api` + `sdk` | `docs/cli/legacy-runtime-core-extraction.md` | partial |
...
| ---- | ------- | ------ | ----- |
| api | `test -f docs/cli/legacy-runtime-core-extraction.md` | pass | new extraction doc |
| api | `test -f docs/waves/v21-3-runtime-core-logic-extraction.md` | pass | new report |
...
* [x] `docs/cli/legacy-runtime-core-extraction.md` exists
* [x] `docs/waves/v21-3-runtime-core-logic-extraction.md` exists
* [x] `yai/Documentation/legacy-cli-runtime-core-extraction.md` exists
* [x] runtime/core legacy areas inspected
* [x] semantics extracted into docs/spec artifacts
