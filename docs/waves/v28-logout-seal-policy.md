...
| ---- | --------- | ----------- | ------ |
| api | `docs/execution/logout-seal-policy.md` | create | logout/seal policy |
| api | `docs/waves/v28-logout-seal-policy.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f docs/execution/logout-seal-policy.md` | pass | new policy doc |
| api | `test -f docs/waves/v28-logout-seal-policy.md` | pass | new report |
...
* [x] `docs/execution/logout-seal-policy.md` exists
* [x] `docs/waves/v28-logout-seal-policy.md` exists
