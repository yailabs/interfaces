...
| api | `docs/api-projection-filesystem.md` | update | record V28.6 projection shape |
| api | `docs/protocol-api-boundary.md` | update | mark current projection-root reality |
| api | `docs/waves/v28-6-protocol-cutover-closure-api-projection-reshape.md` | create | delivery report |
