...
| ---- | ---- | ----------- | ------ |
| api | `docs/case/case-commands.md` | create | canonical case command model |
| api | `docs/waves/v9-case-commands.md` | create | delivery report |
...
| api | `test -f docs/case/case-commands.md` | pass | new command doc |
| api | `test -f docs/waves/v9-case-commands.md` | pass | new report |
...
* [x] `docs/case/case-commands.md` exists
* [x] `docs/waves/v9-case-commands.md` exists
