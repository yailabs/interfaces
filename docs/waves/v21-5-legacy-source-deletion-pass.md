...
| ---- | --------- | ----------- | ------ |
| api | `docs/cli/legacy-source-deletion-pass.md` | create | deletion pass record |
| api | `docs/waves/v21-5-legacy-source-deletion-pass.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f docs/cli/legacy-source-deletion-pass.md` | pass | new doc |
| api | `test -f docs/waves/v21-5-legacy-source-deletion-pass.md` | pass | new report |
...
* [x] `docs/cli/legacy-source-deletion-pass.md` exists
* [x] `docs/waves/v21-5-legacy-source-deletion-pass.md` exists
