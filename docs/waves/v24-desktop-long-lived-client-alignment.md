...
| ---- | --------- | ----------- | ------ |
| api | `docs/client/desktop-long-lived-client-alignment.md` | create | Desktop / long-lived client contract |
| api | `docs/waves/v24-desktop-long-lived-client-alignment.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f docs/client/desktop-long-lived-client-alignment.md` | pass | new client doc |
| api | `test -f docs/waves/v24-desktop-long-lived-client-alignment.md` | pass | new report |
...
* [x] `docs/client/desktop-long-lived-client-alignment.md` exists
* [x] `docs/waves/v24-desktop-long-lived-client-alignment.md` exists
...
* `docs/client/vscode-client-alignment.md` is missing;
* `docs/waves/v23-vscode-client-alignment.md` is missing.
