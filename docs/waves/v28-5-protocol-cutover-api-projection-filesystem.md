...
| api | `docs/api-source-of-truth.md` | update | clarify API exposure vs protocol meaning |
| api | `docs/protocol-api-boundary.md` | create | explicit protocol/API ownership boundary and target API shape |
...
| api | `docs/api-projection-filesystem.md` | create | API projection definition |
| api | `docs/waves/v28-5-protocol-cutover-api-projection-filesystem.md` | create | delivery report |
...
| `docs/waves` | historical delivery reports | keep |
| `docs/execution` | protocol docs / API docs split | deferred/split |
...
| api | `test -f docs/api-projection-filesystem.md` | pass | API filesystem doc |
| api | `test -f docs/waves/v28-5-protocol-cutover-api-projection-filesystem.md` | pass | report |
...
* [x] `api/docs/api-projection-filesystem.md` exists
* [x] `api/docs/waves/v28-5-protocol-cutover-api-projection-filesystem.md` exists
