...
| ---- | --------- | ----------- | ------ |
| api | `docs/execution/analytics-binding.md` | create | analytics binding |
| api | `docs/waves/v34-analytics-binding.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f docs/execution/analytics-binding.md` | pass | new policy doc |
| api | `test -f docs/waves/v34-analytics-binding.md` | pass | new report |
...
* [x] `docs/execution/analytics-binding.md` exists
* [x] `docs/waves/v34-analytics-binding.md` exists
