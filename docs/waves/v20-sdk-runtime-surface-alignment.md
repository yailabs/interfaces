...
| ---- | ---- | ----------- | ------ |
| api | `docs/sdk/sdk-runtime-surface-alignment.md` | create | SDK runtime alignment model |
| api | `docs/waves/v20-sdk-runtime-surface-alignment.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f docs/sdk/sdk-runtime-surface-alignment.md` | pass | new SDK doc |
| api | `test -f docs/waves/v20-sdk-runtime-surface-alignment.md` | pass | new report |
