...
| ---- | --------- | ----------- | ------ |
| api | `docs/execution/flow-binding.md` | create | flow binding |
| api | `docs/waves/v33-flow-binding.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f docs/execution/flow-binding.md` | pass | new policy doc |
| api | `test -f docs/waves/v33-flow-binding.md` | pass | new report |
...
* [x] `docs/execution/flow-binding.md` exists
* [x] `docs/waves/v33-flow-binding.md` exists
