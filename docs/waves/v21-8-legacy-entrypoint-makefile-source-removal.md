...
| ---- | --------- | ----------- | ------ |
| api | `docs/cli/legacy-entrypoint-makefile-source-removal.md` | create | entrypoint/source removal record |
| api | `docs/waves/v21-8-legacy-entrypoint-makefile-source-removal.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f docs/cli/legacy-entrypoint-makefile-source-removal.md` | pass | new doc |
| api | `test -f docs/waves/v21-8-legacy-entrypoint-makefile-source-removal.md` | pass | new report |
...
* [x] `docs/cli/legacy-entrypoint-makefile-source-removal.md` exists
* [x] `docs/waves/v21-8-legacy-entrypoint-makefile-source-removal.md` exists
