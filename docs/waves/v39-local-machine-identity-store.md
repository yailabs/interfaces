...
| ---- | --------- | ----------- | ------ |
| api | `docs/execution/local-machine-identity-store.md` | create | local machine identity boundary |
| api | `docs/waves/v39-local-machine-identity-store.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f docs/execution/local-machine-identity-store.md` | pass | new policy doc |
| api | `test -f docs/waves/v39-local-machine-identity-store.md` | pass | new report |
...
* [x] `docs/execution/local-machine-identity-store.md` exists
* [x] `docs/waves/v39-local-machine-identity-store.md` exists
