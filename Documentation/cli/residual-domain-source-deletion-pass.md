...
| ------------ | ------ | ------------------------- |
| `source/cmd/runtime` | runtime status/control wrapper family was extraction-covered, had no active Rust/Cargo dependency, and had no active `yai/Makefile` file-level dependency | `Documentation/cli/legacy-runtime-core-extraction.md`, `Documentation/cli/legacy-api-sdk-surface-extraction.md` |
| `source/cmd/provider` | provider wrapper family was extraction-covered and not needed by active build/test paths | `Documentation/cli/legacy-runtime-core-extraction.md`, `Documentation/cli/legacy-api-sdk-surface-extraction.md` |
| `source/cmd/agent` | agent wrapper family was extraction-covered and not needed by active build/test paths | `Documentation/cli/legacy-runtime-core-extraction.md`, `Documentation/cli/legacy-api-sdk-surface-extraction.md` |
| `source/cmd/govern` | governance wrapper family was extraction-covered and not needed by active build/test paths | `Documentation/cli/legacy-runtime-core-extraction.md`, `Documentation/cli/legacy-api-sdk-surface-extraction.md` |
| `source/cmd/analytics` | thin derived wrapper family was extraction-covered and not needed by active build/test paths | `Documentation/cli/legacy-runtime-core-extraction.md`, `Documentation/cli/legacy-api-sdk-surface-extraction.md` |
| `source/cmd/logs` | receipt-tail wrapper family was extraction-covered and not needed by active build/test paths | `Documentation/cli/legacy-runtime-core-extraction.md`, `Documentation/cli/legacy-api-sdk-surface-extraction.md` |
| `source/cmd/session` | legacy non-canonical compatibility family was no longer needed by active build/test paths | `Documentation/cli/legacy-api-sdk-surface-extraction.md` |
