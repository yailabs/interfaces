...
| ------------ | ------ | ------------------------- |
| `source/out` | Rendering stubs had no remaining runtime/core or API/SDK semantic value, and the only broader build references were in an unused legacy Makefile inventory list removed in V21.5 | `Documentation/cli/legacy-runtime-core-extraction.md`, `Documentation/cli/legacy-api-sdk-surface-extraction.md` |
| `source/shared` | Legacy argv/path/help/passthrough helpers were already drained into Rust CLI/config surfaces; no Cargo or active yai build dependency remained | `Documentation/cli/legacy-runtime-core-extraction.md`, `Documentation/cli/legacy-api-sdk-surface-extraction.md` |
