...
| ------------ | ------ | ------------------------- |
| `source/main.c` | residual Makefile sentinel/entrypoint anchor was removable after V21.3 runtime/core extraction and V21.4 API/SDK extraction preserved its useful semantics outside `cli/source/` | `Documentation/cli/legacy-runtime-core-extraction.md`, `Documentation/legacy-cli-runtime-core-extraction.md` |
