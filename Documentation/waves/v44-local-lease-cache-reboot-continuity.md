...
| ---- | --------- | ----------- | ------ |
| api | `Documentation/execution/local-lease-cache-reboot-continuity.md` | create | local lease cache boundary |
| api | `Documentation/waves/v44-local-lease-cache-reboot-continuity.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/execution/local-lease-cache-reboot-continuity.md` | pass | new policy doc |
| api | `test -f Documentation/waves/v44-local-lease-cache-reboot-continuity.md` | pass | new report |
...
* [x] `Documentation/execution/local-lease-cache-reboot-continuity.md` exists
* [x] `Documentation/waves/v44-local-lease-cache-reboot-continuity.md` exists
