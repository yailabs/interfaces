...
| ---- | ---- | ----------- | ------ |
| api | `Documentation/cli/legacy-source-extraction-map.md` | create | extraction map |
| api | `Documentation/waves/v21-1-cli-legacy-source-extraction-map.md` | create | delivery report |
...
| `source/assets/shell` | `migration_reference` | `cli/Documentation/remove` | salvage only assets still useful to canonical shell UX |
...
| P2 | shell assets | cli/Documentation/remove | shell UX only |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/cli/legacy-source-extraction-map.md` | pass | new doc |
| api | `test -f Documentation/waves/v21-1-cli-legacy-source-extraction-map.md` | pass | new report |
...
| cli | topology inspection commands | pass | `src/`, `source/`, `Documentation/`, `tests/`, and build inclusion inspected |
