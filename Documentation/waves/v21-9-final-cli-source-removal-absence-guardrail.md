...
| ---- | --------- | ----------- | ------ |
| api | `Documentation/cli/final-cli-source-removal-absence-guardrail.md` | create | final source removal record |
| api | `Documentation/waves/v21-9-final-cli-source-removal-absence-guardrail.md` | create | delivery report |
...
| cli | `Documentation/migration-from-c-cli.md` | update | reflect final absence |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/cli/final-cli-source-removal-absence-guardrail.md` | pass | new doc |
| api | `test -f Documentation/waves/v21-9-final-cli-source-removal-absence-guardrail.md` | pass | new report |
...
* [x] `Documentation/cli/final-cli-source-removal-absence-guardrail.md` exists
* [x] `Documentation/waves/v21-9-final-cli-source-removal-absence-guardrail.md` exists
