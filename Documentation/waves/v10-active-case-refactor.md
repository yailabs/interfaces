...
| ---- | ---- | ----------- | ------ |
| api | `Documentation/operator/active-case-ref.md` | create | active case ownership model |
| api | `Documentation/waves/v10-active-case-refactor.md` | create | delivery report |
...
| api | `test -f Documentation/operator/active-case-ref.md` | pass | new operator doc |
| api | `test -f Documentation/waves/v10-active-case-refactor.md` | pass | new report |
...
* [x] `Documentation/operator/active-case-ref.md` exists
* [x] `Documentation/waves/v10-active-case-refactor.md` exists
