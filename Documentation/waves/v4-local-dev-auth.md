...
| ---- | ---- | ----------- | ------ |
| api | `Documentation/waves/v4-local-dev-auth.md` | create | delivery report |
...
| api | `test -f Documentation/waves/v4-local-dev-auth.md` | pass | new report |
...
* [x] `Documentation/waves/v4-local-dev-auth.md` exists
