...
| ---- | ---- | ----------- | ------ |
| api | `Documentation/cli/cli-sdk-first-wiring.md` | create | CLI SDK-first model |
| api | `Documentation/waves/v21-cli-sdk-first-wiring.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/cli/cli-sdk-first-wiring.md` | pass | new CLI doc |
| api | `test -f Documentation/waves/v21-cli-sdk-first-wiring.md` | pass | new report |
