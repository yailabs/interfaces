...
* Repo change type: VS Code client alignment model + Documentation/report + optional existing extension audit
...
| ---- | --------- | ----------- | ------ |
| api | `Documentation/client/vscode-client-alignment.md` | create | VS Code client alignment model |
| api | `Documentation/waves/v23-vscode-client-alignment.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/client/vscode-client-alignment.md` | pass | new client doc |
| api | `test -f Documentation/waves/v23-vscode-client-alignment.md` | pass | new report |
...
| ---- | ---- | ------ | ----- |
| api | `rg -n "VS Code Client Alignment|long-lived editor client|workspace bound to case_ref|operator_context.active_case_ref|runtime_gate_decision|license_lease|machine_authorization_ref|Supabase user object|billing provider object|legacy session" Documentation/client Documentation/waves` | pass | V23 docs carry required boundary language |
...
* [x] `Documentation/client/vscode-client-alignment.md` exists
* [x] `Documentation/waves/v23-vscode-client-alignment.md` exists
