...
| ---- | ---- | ----------- | ------ |
| api | `Documentation/runtime/service-lifecycle-boundary.md` | create | lifecycle/readiness boundary |
| api | `Documentation/waves/v17-service-lifecycle-boundary.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/runtime/service-lifecycle-boundary.md` | pass | new runtime doc |
| api | `test -f Documentation/waves/v17-service-lifecycle-boundary.md` | pass | new report |
...
* [x] `Documentation/runtime/service-lifecycle-boundary.md` exists
* [x] `Documentation/waves/v17-service-lifecycle-boundary.md` exists
