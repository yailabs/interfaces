...
| ---- | --------- | ----------- | ------ |
| api | `Documentation/cli/legacy-source-guardrail.md` | create | partial guardrail model |
| api | `Documentation/waves/v21-6-cli-source-dependency-recreation-guardrail.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/cli/legacy-source-guardrail.md` | pass | new doc |
| api | `test -f Documentation/waves/v21-6-cli-source-dependency-recreation-guardrail.md` | pass | new report |
...
* [x] `Documentation/cli/legacy-source-guardrail.md` exists
* [x] `Documentation/waves/v21-6-cli-source-dependency-recreation-guardrail.md` exists
