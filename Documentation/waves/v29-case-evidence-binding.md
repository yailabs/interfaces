...
| ---- | --------- | ----------- | ------ |
| api | `Documentation/execution/case-evidence-binding.md` | create | case evidence binding |
| api | `Documentation/waves/v29-case-evidence-binding.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/execution/case-evidence-binding.md` | pass | new policy doc |
| api | `test -f Documentation/waves/v29-case-evidence-binding.md` | pass | new report |
...
* [x] `Documentation/execution/case-evidence-binding.md` exists
* [x] `Documentation/waves/v29-case-evidence-binding.md` exists
