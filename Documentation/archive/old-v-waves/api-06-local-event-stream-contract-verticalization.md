...
| `api` | `Documentation/local-event-stream-contract.md` | added | summarize the API.06 contract |
| `api` | `Documentation/waves/api-06-local-event-stream-contract-verticalization.md` | added | record scope and validation |
