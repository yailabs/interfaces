...
* Repo change type: detach/continuation semantics documentation + optional existing Documentation/status wording alignment
...
| ---- | --------- | ----------- | ------ |
| api | `Documentation/execution/detach-continuation-semantics.md` | create | detach/continuation model |
| api | `Documentation/waves/v27-detach-continuation-semantics.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/execution/detach-continuation-semantics.md` | pass | new execution doc |
| api | `test -f Documentation/waves/v27-detach-continuation-semantics.md` | pass | new report |
...
* [x] `Documentation/execution/detach-continuation-semantics.md` exists
* [x] `Documentation/waves/v27-detach-continuation-semantics.md` exists
