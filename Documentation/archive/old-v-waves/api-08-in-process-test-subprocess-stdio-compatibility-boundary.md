...
| `api` | `Documentation/in-process-subprocess-compat-boundary.md` | added | summarize the split between in-process, subprocess compat, and canonical transports |
| `api` | `Documentation/waves/api-08-in-process-test-subprocess-stdio-compatibility-boundary.md` | added | record scope and validation |
