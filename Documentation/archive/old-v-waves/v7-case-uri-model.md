...
| ---- | ---- | ----------- | ------ |
| api | `Documentation/case/case-uri-model.md` | create/update | canonical case URI grammar |
| api | `Documentation/case/root-user-case.md` | update | mark `case://user` provisional and document concrete root |
| api | `Documentation/waves/v6-root-user-case.md` | update | record V6 naming correction |
| api | `Documentation/waves/v7-case-uri-model.md` | create/update | delivery report |
...
| api | `test -f Documentation/case/case-uri-model.md` | pass | new URI doc |
| api | `test -f Documentation/waves/v7-case-uri-model.md` | pass | new report |
...
rg -n "case://<account-username>|case://francesco|case://me|case URI|Case URI|placeholder|provisional|nested path|session remains legacy" Documentation/case Documentation/waves
```
...
* [x] `Documentation/case/case-uri-model.md` exists
* [x] `Documentation/waves/v7-case-uri-model.md` exists
