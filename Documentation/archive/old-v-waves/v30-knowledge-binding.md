...
| ---- | --------- | ----------- | ------ |
| api | `Documentation/execution/knowledge-binding.md` | create | case knowledge binding |
| api | `Documentation/waves/v30-knowledge-binding.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/execution/knowledge-binding.md` | pass | new policy doc |
| api | `test -f Documentation/waves/v30-knowledge-binding.md` | pass | new report |
...
* [x] `Documentation/execution/knowledge-binding.md` exists
* [x] `Documentation/waves/v30-knowledge-binding.md` exists
