...
| ---- | ---- | ----------- | ------ |
| api | `Documentation/runtime/allowed-blocked-surfaces.md` | create | allowed/blocked matrix |
| api | `Documentation/waves/v16-allowed-blocked-surfaces.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/runtime/allowed-blocked-surfaces.md` | pass | new runtime doc |
| api | `test -f Documentation/waves/v16-allowed-blocked-surfaces.md` | pass | new report |
...
* [x] `Documentation/runtime/allowed-blocked-surfaces.md` exists
* [x] `Documentation/waves/v16-allowed-blocked-surfaces.md` exists
