...
| ---- | ---- | ----------- | ------ |
| api | `Documentation/cli/canonical-cli-invocation.md` | create | canonical installed CLI workflow |
| api | `Documentation/waves/v10-5-canonical-cli-install-and-invocation.md` | create | delivery report |
...
| api | `test -f Documentation/cli/canonical-cli-invocation.md` | pass | new doc |
| api | `test -f Documentation/waves/v10-5-canonical-cli-install-and-invocation.md` | pass | new report |
...
* [x] `Documentation/cli/canonical-cli-invocation.md` exists
* [x] `Documentation/waves/v10-5-canonical-cli-install-and-invocation.md` exists
