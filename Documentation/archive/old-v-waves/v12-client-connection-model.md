...
| ---- | ---- | ----------- | ------ |
| api | `Documentation/client/client-connection-model.md` | create | canonical client connection model |
| api | `Documentation/waves/v12-client-connection-model.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/client/client-connection-model.md` | pass | new client doc |
| api | `test -f Documentation/waves/v12-client-connection-model.md` | pass | new report |
...
```bash
rg -n "client connection|client_ref|cli-one-shot|loom-tui|sdk-embedded|long-lived|one-shot|shell lifecycle|session remains legacy|runtime carrier" Documentation/client Documentation/waves Documentation/operator Documentation/cli
```
...
Expected:
matches in V12 docs and any touched Documentation/help.
...
* [x] `Documentation/client/client-connection-model.md` exists
* [x] `Documentation/waves/v12-client-connection-model.md` exists
