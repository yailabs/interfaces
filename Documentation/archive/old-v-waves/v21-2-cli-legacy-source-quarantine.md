...
| ---- | ---- | ----------- | ------ |
| api | `Documentation/cli/legacy-source-quarantine.md` | create | quarantine policy |
| api | `Documentation/waves/v21-2-cli-legacy-source-quarantine.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/cli/legacy-source-quarantine.md` | pass | new doc |
| api | `test -f Documentation/waves/v21-2-cli-legacy-source-quarantine.md` | pass | new report |
| api | `python3 conformance/check_api_contracts.py` | pass | available |
| cli | `cargo fmt --check` | pass | required because CLI Documentation/source docs touched |
| cli | `cargo test` | pass | required because CLI Documentation/source docs touched |
| cli | `cargo build` | pass | required because CLI Documentation/source docs touched |
...
* [x] `Documentation/cli/legacy-source-quarantine.md` exists
* [x] `Documentation/waves/v21-2-cli-legacy-source-quarantine.md` exists
