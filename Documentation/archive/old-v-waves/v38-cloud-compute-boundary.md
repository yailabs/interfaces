...
| ---- | --------- | ----------- | ------ |
| api | `Documentation/execution/cloud-compute-boundary.md` | create | cloud compute boundary |
| api | `Documentation/waves/v38-cloud-compute-boundary.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/execution/cloud-compute-boundary.md` | pass | new policy doc |
| api | `test -f Documentation/waves/v38-cloud-compute-boundary.md` | pass | new report |
...
* [x] `Documentation/execution/cloud-compute-boundary.md` exists
* [x] `Documentation/waves/v38-cloud-compute-boundary.md` exists
