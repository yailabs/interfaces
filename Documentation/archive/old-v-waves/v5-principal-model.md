...
| ---- | ---- | ----------- | ------ |
| api | `Documentation/identity/principal-model.md` | create | canonical identity model |
| api | `Documentation/waves/v5-principal-model.md` | create | delivery report |
...
| api | `test -f Documentation/identity/principal-model.md` | pass | new identity doc |
| api | `test -f Documentation/waves/v5-principal-model.md` | pass | new report |
...
rg -n "principal|account_ref|auth_context|entitlement_ref|machine_authorization_ref|case_ref|local-dev|session remains legacy" Documentation/identity Documentation/waves
```
...
* [x] `Documentation/identity/principal-model.md` exists
* [x] `Documentation/waves/v5-principal-model.md` exists
