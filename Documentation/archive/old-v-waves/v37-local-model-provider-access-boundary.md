...
| ---- | --------- | ----------- | ------ |
| api | `Documentation/execution/local-model-provider-access-boundary.md` | create | model/provider access boundary |
| api | `Documentation/waves/v37-local-model-provider-access-boundary.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/execution/local-model-provider-access-boundary.md` | pass | new policy doc |
| api | `test -f Documentation/waves/v37-local-model-provider-access-boundary.md` | pass | new report |
...
* [x] `Documentation/execution/local-model-provider-access-boundary.md` exists
* [x] `Documentation/waves/v37-local-model-provider-access-boundary.md` exists
