...
| ---- | ---- | ----------- | ------ |
| api | `Documentation/cli/legacy-api-sdk-surface-extraction.md` | create | API/SDK extraction artifact |
| api | `Documentation/waves/v21-4-api-sdk-surface-extraction.md` | create | delivery report |
| sdk | `Documentation/legacy-cli-surface-candidates.md` | create | SDK candidate surface record |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/cli/legacy-api-sdk-surface-extraction.md` | pass | new extraction doc |
| api | `test -f Documentation/waves/v21-4-api-sdk-surface-extraction.md` | pass | new report |
| api | `python3 conformance/check_api_contracts.py` | pass | `api-contracts: ok` |
| sdk | `test -f Documentation/legacy-cli-surface-candidates.md` | pass | new SDK candidate doc |
...
* [x] `Documentation/cli/legacy-api-sdk-surface-extraction.md` exists
* [x] `Documentation/waves/v21-4-api-sdk-surface-extraction.md` exists
* [x] `sdk/Documentation/legacy-cli-surface-candidates.md` exists
