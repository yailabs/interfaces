...
| ---- | --------- | ----------- | ------ |
| api | `Documentation/execution/runtime-license-check-request.md` | create | runtime license check request boundary |
| api | `Documentation/waves/v46-runtime-license-check-request.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/execution/runtime-license-check-request.md` | pass | new policy doc |
| api | `test -f Documentation/waves/v46-runtime-license-check-request.md` | pass | new report |
...
* [x] `Documentation/execution/runtime-license-check-request.md` exists
* [x] `Documentation/waves/v46-runtime-license-check-request.md` exists
