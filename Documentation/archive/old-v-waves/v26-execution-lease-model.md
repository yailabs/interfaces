...
* Repo change type: execution lease model documentation + optional existing Documentation/status wording alignment
...
| ---- | --------- | ----------- | ------ |
| api | `Documentation/execution/execution-lease-model.md` | create | execution lease model |
| api | `Documentation/waves/v26-execution-lease-model.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/execution/execution-lease-model.md` | pass | new execution doc |
| api | `test -f Documentation/waves/v26-execution-lease-model.md` | pass | new report |
...
* [x] `Documentation/execution/execution-lease-model.md` exists
* [x] `Documentation/waves/v26-execution-lease-model.md` exists
