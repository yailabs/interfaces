...
| ---- | --------- | ----------- | ------ |
| api | `Documentation/execution/agent-authority-binding.md` | create | agent authority binding |
| api | `Documentation/waves/v32-agent-authority-binding.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/execution/agent-authority-binding.md` | pass | new policy doc |
| api | `test -f Documentation/waves/v32-agent-authority-binding.md` | pass | new report |
...
* [x] `Documentation/waves/v32-agent-authority-binding.md` exists
