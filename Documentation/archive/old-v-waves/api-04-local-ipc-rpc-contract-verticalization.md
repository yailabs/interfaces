...
| `api` | `Documentation/local-ipc-rpc-contract.md` | added | summarize the API.04 contract |
| `api` | `Documentation/waves/api-04-local-ipc-rpc-contract-verticalization.md` | added | record scope and validation |
