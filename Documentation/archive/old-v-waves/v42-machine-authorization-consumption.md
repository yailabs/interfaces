...
| ---- | --------- | ----------- | ------ |
| api | `Documentation/execution/machine-authorization-consumption.md` | create | machine authorization consumption |
| api | `Documentation/waves/v42-machine-authorization-consumption.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/execution/machine-authorization-consumption.md` | pass | new policy doc |
| api | `test -f Documentation/waves/v42-machine-authorization-consumption.md` | pass | new report |
...
* [x] `Documentation/execution/machine-authorization-consumption.md` exists
* [x] `Documentation/waves/v42-machine-authorization-consumption.md` exists
