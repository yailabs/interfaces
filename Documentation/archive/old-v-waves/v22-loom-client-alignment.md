...
* Repo change type: Loom client alignment audit + Documentation/UX wording alignment + optional truthful posture display refinement
...
| ---- | --------- | ----------- | ------ |
| api | `Documentation/client/loom-client-alignment.md` | create | Loom client alignment model |
| api | `Documentation/waves/v22-loom-client-alignment.md` | create | delivery report |
| loom | `README.md` | update | align Loom client language |
| loom | `Documentation/product-boundary.md` | update | long-lived client boundary |
| loom | `Documentation/runtime-readiness.md` | update | truthful readiness/client wording |
| loom | `Documentation/sdk-first-client-contract.md` | update | SDK/Loom ownership boundary |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/client/loom-client-alignment.md` | pass | new client doc |
| api | `test -f Documentation/waves/v22-loom-client-alignment.md` | pass | new report |
...
* [x] `Documentation/client/loom-client-alignment.md` exists
* [x] `Documentation/waves/v22-loom-client-alignment.md` exists
