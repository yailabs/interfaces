...
* Repo change type: case-bound job model documentation + optional existing Documentation/status wording alignment
...
| ---- | --------- | ----------- | ------ |
| api | `Documentation/execution/case-bound-jobs.md` | create | case-bound job model |
| api | `Documentation/waves/v25-case-bound-jobs.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/execution/case-bound-jobs.md` | pass | new execution doc |
| api | `test -f Documentation/waves/v25-case-bound-jobs.md` | pass | new report |
...
* [x] `Documentation/execution/case-bound-jobs.md` exists
* [x] `Documentation/waves/v25-case-bound-jobs.md` exists
