...
| ---- | ---- | ----------- | ------ |
| api | `Documentation/cli/cli-runtime-binary-boundary.md` | create | CLI/runtime binary boundary |
| api | `Documentation/waves/v10-6-cli-binary-precedence-runtime-boundary.md` | create | delivery report |
| api | `Documentation/cli/canonical-cli-invocation.md` | update | cross-link/residual closure |
...
| api | `test -f Documentation/cli/cli-runtime-binary-boundary.md` | pass | new doc |
| api | `test -f Documentation/waves/v10-6-cli-binary-precedence-runtime-boundary.md` | pass | new report |
...
* [x] `Documentation/cli/cli-runtime-binary-boundary.md` exists
* [x] `Documentation/waves/v10-6-cli-binary-precedence-runtime-boundary.md` exists
