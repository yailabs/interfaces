...
| ---- | --------- | ----------- | ------ |
| api | `Documentation/execution/license-lease-consumption.md` | create | license lease consumption |
| api | `Documentation/waves/v43-license-lease-consumption.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/execution/license-lease-consumption.md` | pass | new policy doc |
| api | `test -f Documentation/waves/v43-license-lease-consumption.md` | pass | new report |
...
* [x] `Documentation/execution/license-lease-consumption.md` exists
* [x] `Documentation/waves/v43-license-lease-consumption.md` exists
