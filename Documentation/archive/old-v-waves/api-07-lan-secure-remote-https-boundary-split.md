...
| `api` | `Documentation/lan-secure-remote-https-boundary.md` | added | summarize the split between LAN Secure, Remote HTTPS, loopback, and provider transport |
| `api` | `Documentation/waves/api-07-lan-secure-remote-https-boundary-split.md` | added | record scope and validation |
