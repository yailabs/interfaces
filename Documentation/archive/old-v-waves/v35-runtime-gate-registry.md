...
| ---- | --------- | ----------- | ------ |
| api | `Documentation/execution/runtime-gate-registry.md` | create | runtime gate registry |
| api | `Documentation/waves/v35-runtime-gate-registry.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/execution/runtime-gate-registry.md` | pass | new policy doc |
| api | `test -f Documentation/waves/v35-runtime-gate-registry.md` | pass | new report |
...
* [x] `Documentation/waves/v35-runtime-gate-registry.md` exists
