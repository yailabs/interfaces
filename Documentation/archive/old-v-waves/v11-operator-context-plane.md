...
| ---- | ---- | ----------- | ------ |
| api | `Documentation/operator/operator-context-plane.md` | create | canonical operator context model |
| api | `Documentation/waves/v11-operator-context-plane.md` | create | delivery report |
...
| api | `test -f Documentation/case/case-commands.md` | pass | baseline |
| api | `test -f Documentation/waves/v9-case-commands.md` | pass | baseline |
| api | `test -f Documentation/operator/active-case-ref.md` | pass | baseline |
| api | `test -f Documentation/waves/v10-active-case-refactor.md` | pass | baseline |
| api | `test -f Documentation/cli/canonical-cli-invocation.md` | pass | baseline |
| api | `test -f Documentation/waves/v10-5-canonical-cli-install-and-invocation.md` | pass | baseline |
| api | `test -f Documentation/cli/cli-runtime-binary-boundary.md` | pass | baseline |
| api | `test -f Documentation/waves/v10-6-cli-binary-precedence-runtime-boundary.md` | pass | baseline |
| api | `test -f Documentation/operator/operator-context-plane.md` | pass | new operator context doc |
| api | `test -f Documentation/waves/v11-operator-context-plane.md` | pass | new report |
...
```bash
rg -n "operator context|operator_context|active_case_ref|client_ref|shell_ref|auth_context|root_case_ref|session remains legacy|installed CLI|runtime carrier|session" Documentation/operator Documentation/waves Documentation/case Documentation/cli
```
...
* [x] `Documentation/operator/operator-context-plane.md` exists
* [x] `Documentation/waves/v11-operator-context-plane.md` exists
