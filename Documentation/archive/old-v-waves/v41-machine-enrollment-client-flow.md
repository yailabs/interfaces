...
| ---- | --------- | ----------- | ------ |
| api | `Documentation/execution/machine-enrollment-client-flow.md` | create | machine enrollment client flow |
| api | `Documentation/waves/v41-machine-enrollment-client-flow.md` | create | delivery report |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/execution/machine-enrollment-client-flow.md` | pass | new policy doc |
| api | `test -f Documentation/waves/v41-machine-enrollment-client-flow.md` | pass | new report |
...
* [x] `Documentation/execution/machine-enrollment-client-flow.md` exists
* [x] `Documentation/waves/v41-machine-enrollment-client-flow.md` exists
