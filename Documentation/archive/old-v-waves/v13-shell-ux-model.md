...
| ---- | ---- | ----------- | ------ |
| api | `Documentation/client/shell-ux-model.md` | create | canonical shell UX model |
| api | `Documentation/waves/v13-shell-ux-model.md` | create | delivery report |
...
| loom | `Documentation/sdk-first-client-contract.md` | docs | shell plane boundary wording |
...
| ---- | ------- | ------ | ----- |
| api | `test -f Documentation/client/shell-ux-model.md` | pass | new shell doc |
| api | `test -f Documentation/waves/v13-shell-ux-model.md` | pass | new report |
...
```bash
rg -n "shell UX|shell != session|shell attach|shell detach|auth login|auth logout|case enter|case leave|runtime start|runtime stop|session remains legacy" Documentation/client Documentation/waves Documentation/operator
```
...
Expected:
matches in V13 docs and touched Documentation/help.
...
* [x] `Documentation/client/shell-ux-model.md` exists
* [x] `Documentation/waves/v13-shell-ux-model.md` exists
