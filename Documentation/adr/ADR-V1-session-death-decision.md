...
| historical Documentation/reference | old behavior explanation | must be clearly marked legacy/non-canonical |
...
* [x] ADR file exists at `Documentation/adr/ADR-V1-session-death-decision.md`
...
* [x] `Documentation/adr/ADR-V1-session-death-decision.md` exists
